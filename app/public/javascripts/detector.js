...
define([], function () {
    var Detector = function () {
        ...
        /**
         * Return the precalculated mobile check.
         * @return {Boolean}
         */
        ...
        _createClass(Detector, [{
            ...
            /**
             * Performs a regex check whether the client is a mobile device.
             * @return {Boolean}
             */

        }, {
            key: '_setMobile',
            value: function _setMobile() {
                var check = false;
                (function (a) {
            ...
            value: function _handleOrientation(e) {
                if (this._handlersMap.hasOwnProperty('orientation')) {
                    var alpha = e.alpha;
                    var beta = e.beta;
                    var gamma = e.gamma;
